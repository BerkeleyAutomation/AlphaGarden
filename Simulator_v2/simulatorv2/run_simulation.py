...
def run_simulation(args):
    ...
    garden = Garden(plants, NUM_X_STEPS, NUM_Y_STEPS, STEP, plant_types=['basil', 'thyme', 'oregano'] + ['lavender', 'bok-choy', "parsley", "sage", "rosemary", "thyme"], animate=(args.display != 'p'))
