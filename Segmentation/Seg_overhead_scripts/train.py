...
# model_unet = sm.PSPNet(backbone_name=BACKBONE,encoder_weights='imagenet',downsample_factor=4,input_shape=(IM_HEIGHT,IM_WIDTH,  3),psp_pooling_type='max',activation=ACTIVATION_FN, classes=N_CLASSES)
