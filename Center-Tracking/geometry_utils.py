...
def find_circle(max_pair, other_min, other_max):
        ...
        max_pair_mid_point = ((max_pair[0][0] + max_pair[1][0]) / 2, (max_pair[0][1] + max_pair[1][1]) / 2)
        other_defining_point = max([other_min, other_max], key=lambda p: distance(p, max_pair_mid_point))
