...
def loss_computation(logits_list, labels, losses, edges=None):
    ...
    for i in range(len(logits_list)):
        ...
        elif loss_i.__class__.__name__ in ("CrossEntropyLoss"):
            loss_list.append(losses['coef'][i] * loss_i(logits.astype('float64'), labels.astype('int64')))
        else:
            # print("IN!")
            loss_list.append(losses['coef'][i] * loss_i(logits.astype('float64'), labels.astype("float64")))
    return loss_list
