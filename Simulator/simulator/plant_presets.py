...
MAX_RADIUS = {"fast0_0": (100.0, 0), "fast1_0": (90.5, 0), "fast2_0": (80.0, 0), "fast3_0": (70.5, 0), "fast4_0": (60.0, 0), "slow0_0": (10.0, 0), "slow1_0": (18.75, 0), "slow2_0": (27.5, 0), "slow3_0": (30, 0), "slow4_0": (35.0, 0)}
...
PLANT_TYPES = {
    "fast0_0": _compute_from_table_values(name = 'fast0_0', color= [(9 / 255, 77 / 255, 10 / 255),(0.9467, 0.6863, 0.2431)][SEG_COLORS], germination_time=(3, 0), r_max =(50.0, 0), maturation_time=(100, 0), stopping_color = (0.5882352941176471, 0, 1), r_0 = 1, c1 =0.2, MAX_RADIUS= MAX_RADIUS),
    "fast1_0": _compute_from_table_values(name = 'fast1_0', color= [(9 / 255, 77 / 255, 10 / 255),(0.9467, 0.6863, 0.2431)][SEG_COLORS], germination_time=(7, 0), r_max =(62.5, 0), maturation_time=(110, 0), stopping_color = (0.5882352941176471, 0, 1), r_0 = 1, c1 = 0.25, MAX_RADIUS= MAX_RADIUS),
    "fast2_0": _compute_from_table_values(name = 'fast2_0', color= [(9 / 255, 77 / 255, 10 / 255),(0.9467, 0.6863, 0.2431)][SEG_COLORS], germination_time=(11, 0), r_max =(75.0, 0), maturation_time=(99, 0), stopping_color = (0.5882352941176471, 0, 1), r_0 = 1, c1 =0.23, MAX_RADIUS= MAX_RADIUS),
    "fast3_0": _compute_from_table_values(name = 'fast3_0', color= [(9 / 255, 77 / 255, 10 / 255),(0.9467, 0.6863, 0.2431)][SEG_COLORS], germination_time=(13.0, 0), r_max =(87.5, 0), maturation_time=(95, 0), stopping_color = (0.5882352941176471, 0, 1), r_0 = 1, c1 =0.18, MAX_RADIUS= MAX_RADIUS),
    "fast4_0": _compute_from_table_values(name = 'fast4_0', color= [(9 / 255, 77 / 255, 10 / 255),(0.9467, 0.6863, 0.2431)][SEG_COLORS], germination_time=(15, 0), r_max =(100.0, 0), maturation_time=(93.0, 0), stopping_color = (0.5882352941176471, 0, 1), r_0 = 1, c1 =0.2, MAX_RADIUS= MAX_RADIUS),
    "slow0_0": _compute_from_table_values(name = 'slow0_0', color= [(101 / 255, 179 / 255, 53 / 255), (0.2, 0.4784, 0.3765)][SEG_COLORS], germination_time=(16.0, 0), r_max =(5.0, 0), maturation_time=(150.0, 0), stopping_color = (0.5882352941176471, 0, 1), r_0 = 1, c1 =0.15, MAX_RADIUS= MAX_RADIUS),
    "slow1_0": _compute_from_table_values(name = 'slow1_0', color=[(101 / 255, 179 / 255, 53 / 255), (0.2, 0.4784, 0.3765)][SEG_COLORS], germination_time=(21, 0), r_max =(13.75, 0), maturation_time=(175, 0), stopping_color = (0.5882352941176471, 0, 1), r_0 = 1, c1 =0.03, MAX_RADIUS= MAX_RADIUS),
    "slow2_0": _compute_from_table_values(name = 'slow2_0', color= [(101 / 255, 179 / 255, 53 / 255), (0.2, 0.4784, 0.3765)][SEG_COLORS], germination_time=(29, 0), r_max =(22.5, 0), maturation_time=(125.0, 0), stopping_color = (0.5882352941176471, 0, 1), r_0 = 1, c1 =0.05, MAX_RADIUS= MAX_RADIUS),
    "slow3_0": _compute_from_table_values(name = 'slow3_0', color= [(101 / 255, 179 / 255, 53 / 255), (0.2, 0.4784, 0.3765)][SEG_COLORS], germination_time=(32, 0), r_max =(25, 0), maturation_time=(150, 0), stopping_color = (0.5882352941176471, 0, 1), r_0 = 1, c1 =0.03, MAX_RADIUS= MAX_RADIUS),
    "slow4_0": _compute_from_table_values(name = 'slow4_0', color= [(101 / 255, 179 / 255, 53 / 255), (0.2, 0.4784, 0.3765)][SEG_COLORS], germination_time=(30.0, 0), r_max =(30.0, 0), maturation_time=(180.0, 0), stopping_color = (0.5882352941176471, 0, 1), r_0 = 1, c1 =0.02, MAX_RADIUS= MAX_RADIUS)
}