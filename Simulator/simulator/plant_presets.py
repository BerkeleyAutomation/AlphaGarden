...
PLANT_TYPES = {
   ...
   #     small plants below 20 threshold
   # regular plants little pruning vs heavy pruning.
   # very invasive species little pruning vs heavy pruning.
   # "test1": _compute_from_table_values(name="test1", color=(9/255, 47/255, 10/255), germination_time=(18, 22),
   #                                       seed_spacing=150, maturation_time=40, stopping_color=(119/255, 0, 1)),
   # "test2": _compute_from_table_values(name="test2", color=(86/255, 139/255, 31/255), germination_time=(20, 25),
   #                                        seed_spacing=1676, maturation_time=54, stopping_color=(115/255, 0, 1)),
   # "basil": _compute_from_table_values(name="basil", color=(9/255, 77/255, 10/255), germination_time=(17, 25),
   #                                     seed_spacing=50, maturation_time=56, stopping_color=(150/255, 0, 1)),
   "test3": _compute_from_table_values(name="test3", color=(0, 183/255, 0), germination_time=(33, 34),
                                          seed_spacing=3802, maturation_time=75, stopping_color=(120/255, 63/255, 1), color_step=(10/255, -10/255, 0/255)),
   "parsley": _compute_from_table_values(name="parsley", color=(142/255, 229/255, 52/255), germination_time=(31, 35),
                                         seed_spacing=408, maturation_time=70, stopping_color=(142/255, 0, 1), color_step=(-20/255, 0/255, 0/255)),
   "sage2": _compute_from_table_values(name="sage2", color=(62/255, 159/255, 78/255), germination_time=(38, 40),
                                      seed_spacing=412, maturation_time=90, stopping_color=(132/255, 89/255, 1), color_step=(10/255, -10/255, 0/255)),
   "test4": _compute_from_table_values(name="test4", color=(0, 230/255, 0), germination_time=(65, 70),
                                          seed_spacing=32802, maturation_time=128, stopping_color=(140/255, 90/255, 1), color_step=(10/255, -10/255, 0/255)),
   "thyme2": _compute_from_table_values(name="thyme2", color=(101/255, 179/255, 53/255), germination_time=(48, 50),
                                       seed_spacing=708, maturation_time=110, stopping_color=(191/255, 134/255, 1), color_step=(10/255, -5/255, 0/255)),
   # "test5": _compute_from_table_values(name="test5", color=(58/255, 167/255, 100/255), germination_time=(55, 61),
   #                                      seed_spacing=20205, maturation_time=110, stopping_color=(198/255, 0, 1)),
   # "cilantro": _compute_from_table_values(name="cilantro", color=(91/255, 224/255, 54/255), germination_time=(57, 60),
   #                                        seed_spacing=700, maturation_time=110, stopping_color=(181/255, 134/255, 1),
...
#     #"rosemary": _compute_from_table_values(name="rosemary", color=(0, 230/255, 0), germination_time=(15, 25),
#     #                                        seed_spacing=21, maturation_time=183, stopping_color=(140/255, 90/255, 1), color_step=(10/255, -10/255, 0/255)),
#     # "thyme": (name="thyme", color=(101/255, 179/255, 53/255), germination_time=(8, 20),
#     #                                     seed_spacing=21,_compute_from_table_values maturation_time=95, stopping_color=(191/255, 134/255, 1), color_step=(10/255, -5/255, 0/255)),
#     "chives": _compute_from_table_values(name="chives", color=(58/255, 167/255, 100/255), germination_time=(15, 21),
#                                           seed_spacing=7.5, maturation_time=90, stopping_color=(198/255, 0, 1)),
#     "cilantro": _compute_from_table_values(name="cilantro", color=(91/255, 224/255, 54/255), germination_time=(7, 10),
#                                            seed_spacing=4, maturation_time=68, stopping_color=(181/255, 134/255, 1),
