...
#         "green_lettuce":{"borage": 0.0, "sorrel": 0.0,  "cilantro": 0.0, "radicchio": 0.0, "kale": 0.0, "green_lettuce": SRV, "red_lettuce":-1.0, "arugula":-1.0, "swiss_chard": 0.0, "turnip": 0.0},
...
#         "arugula":      {"borage": 0.0, "sorrel": 0.0,  "cilantro": 0.0, "radicchio": 0.0, "kale": 0.0, "green_lettuce": 0.0, "red_lettuce": 0.0, "arugula": SRV, "swiss_chard": 0.0, "turnip": 0.0},
...
PLANT_TYPES = {
    ...
    "borage": _compute_from_table_values(name="borage", color=[(9 / 255, 77 / 255, 10 / 255),(0.9467, 0.6863, 0.2431)][SEG_COLORS], germination_time=(8, 1),
    ...
    "sorrel": _compute_from_table_values(name="sorrel", color=[(167 / 255, 247 / 255, 77 / 255), (0.9294, 0.2, 0.2412)][SEG_COLORS],
                                         ...
                                         seed_spacing=SEED_SPACING["sorrel"], maturation_time=69,
    ...
    "cilantro": _compute_from_table_values(name="cilantro", color=[(101 / 255, 179 / 255, 53 / 255), (0.2, 0.4784, 0.3765)][SEG_COLORS],
                                           germination_time=(8, 1),
                                           seed_spacing=SEED_SPACING["cilantro"], maturation_time=70,
    ...
    "radicchio": _compute_from_table_values(name="radicchio", color=[(147 / 255, 199 / 255, 109 / 255),(0.7333, 0.6980, 0.0934)][SEG_COLORS],
                                            germination_time=(9, 1),
                                            seed_spacing=SEED_SPACING["radicchio"], maturation_time=63,
                                            stopping_color=(122 / 255, 99 / 255, 1)),
    # https://www.superseeds.com/products/dwarf-blue-curled-kale-55-days
    "kale": _compute_from_table_values(name="kale", color=[(117 / 255, 158 / 255, 81 / 255),(0.1137, 0.2588, 0.8510)][SEG_COLORS],
                                       germination_time=(8, 2),
                                       seed_spacing=SEED_SPACING["kale"], maturation_time=55,
    ...
    "green_lettuce": _compute_from_table_values(name="green_lettuce", color=[(142 / 255, 199 / 255, 52 / 255),(0.4275, 0.8667, 0.6941)][SEG_COLORS],
                                                germination_time=(8, 1),
                                                seed_spacing=SEED_SPACING["green_lettuce"], maturation_time=52,
    ...
    "red_lettuce": _compute_from_table_values(name="red_lettuce", color=[(117 / 255, 128 / 255, 81 / 255),(0.5098, 0.2784, 0.8549)][SEG_COLORS],
                                              germination_time=(12, 1),
                                              seed_spacing=SEED_SPACING["red_lettuce"], maturation_time=67,
    ...
    "swiss_chard": _compute_from_table_values(name="swiss_chard", color=[(58 / 255, 137 / 255, 100 / 255), (0.8196, 0.2863, 0.6510)][SEG_COLORS],
                                              germination_time=(8, 2),
                                              seed_spacing=SEED_SPACING["swiss_chard"], maturation_time=52,
                                              stopping_color=(188 / 255, 137 / 255, 1)),
    # rhs.org.uk/advice/grow-your-own/vegetables/turnip
    "turnip": _compute_from_table_values(name="turnip", color=[(0, 230 / 255, 0), (0.9333, 0.3804, 0.3725)][SEG_COLORS],
                                         germination_time=(5, 1),
                                         seed_spacing=SEED_SPACING["turnip"], maturation_time=47,
